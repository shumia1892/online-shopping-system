...
<head>
    ...
    <link rel="stylesheet" href="{{asset('/public/admin')}}/ckeditor/sample/css/samples.css">
    <link rel="stylesheet" href="{{asset('/public/admin')}}/ckeditor/sample/toolbarconfigurator/lib/codemirror/neo.css">
</head>
...
<script src="{{asset('/public/admin')}}/ckeditor/samples/js/sample.js"></script>
<script>
    initSample();
</script>

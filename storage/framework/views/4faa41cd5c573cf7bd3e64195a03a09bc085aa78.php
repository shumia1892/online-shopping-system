...
<head>
    ...
    <link href="<?php echo e(asset('/public/admin')); ?>/css/sb-admin-2.min.css" rel="stylesheet">

    <link href="<?php echo e(asset('/public/admin')); ?>/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo e(asset('/public/admin')); ?>/ckeditor/sample/css/samples.css">
    <link rel="stylesheet" href="<?php echo e(asset('/public/admin')); ?>/ckeditor/sample/toolbarconfigurator/lib/codemirror/neo.css">
</head>
...
<div id="wrapper">
    ...
    <!-- Sidebar -->
    <?php echo $__env->make('admin.includes.sideber', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <!-- End of Sidebar -->

    <!-- Content Wrapper -->
    <div id="content-wrapper" class="d-flex flex-column">
    <?php echo $__env->make('admin.includes.navber', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <!-- Main Content -->
        <div id="content">
...
<script src="<?php echo e(asset('/public/admin')); ?>/js/demo/chart-area-demo.js"></script>
<script src="<?php echo e(asset('/public/admin')); ?>/js/demo/chart-pie-demo.js"></script>

<script src="<?php echo e(asset('/public/admin')); ?>/js/demo/datatables-demo.js"></script>
<script src="<?php echo e(asset('/public/admin')); ?>/ckeditor/ckeditor.js"></script>
<script src="<?php echo e(asset('/public/admin')); ?>/ckeditor/samples/js/sample.js"></script>
<script>
    initSample();
</script>

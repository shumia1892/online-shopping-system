                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="single-product">
                                    <div class="product-img">
                                        <img
                                                class="card-img"
                                                src="<?php echo e(asset($catProduct->main_image)); ?>"
                                                alt=""
                                        />
                                        <div class="p_icon">
                                            <a href="#">
                                    ...
                                    <div class="product-btm">
                                        <a href="<?php echo e(route('product-details',['id'=>$catProduct->id])); ?>" class="d-block">
                                            <h4><?php echo e($catProduct->product_name); ?></h4>
                                        </a>
                                        <div class="mt-3">
                                            <span class="mr-4"><?php echo e($catProduct->product_price); ?></span>
                                            <del>$35.00</del>
                                        </div>
                                    </div>
                                </div>
